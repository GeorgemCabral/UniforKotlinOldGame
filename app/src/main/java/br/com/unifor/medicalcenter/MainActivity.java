        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            Button_LOGIN = (Button) findViewById(R.id.button2)
                    Button_LOGIN.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent = new Intent(layout_main.this menuprincipal.class);


                        }

                    });
            Button_CADASTRO = (Button) findViewById(R.id.button3)
                    Button_CADASTRO.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                        Intent intent = new Intent(layout_main.this cadastro.class);
                }
